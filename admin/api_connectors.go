...
func (r ApiListConnectorsRequest) Q(q string) ApiListConnectorsRequest {
	r.q = &q
	return r
}
...
type ApiUpdateTriggerConnectorRequest struct {
	ctx context.Context
	ApiService *ConnectorsAPIService
	id string
	updateTriggerConnectorRequest *UpdateTriggerConnectorRequest
	xProjectId *string
}

func (r ApiUpdateTriggerConnectorRequest) UpdateTriggerConnectorRequest(updateTriggerConnectorRequest UpdateTriggerConnectorRequest) ApiUpdateTriggerConnectorRequest {
	r.updateTriggerConnectorRequest = &updateTriggerConnectorRequest
	return r
}

// Project the request operates on. Optional — defaults to the project the SDK key belongs to; pass it only to scope a multi-project key (the generated client sets it once from its configuration, so per-call callers never thread it).
func (r ApiUpdateTriggerConnectorRequest) XProjectId(xProjectId string) ApiUpdateTriggerConnectorRequest {
	r.xProjectId = &xProjectId
	return r
}

func (r ApiUpdateTriggerConnectorRequest) Execute() (*UpdateConnectorResponse, *http.Response, error) {
	return r.ApiService.UpdateTriggerConnectorExecute(r)
}

/*
UpdateTriggerConnector Update a trigger connector
...
**Use case:** Re-point a Cursor trigger at a new repo ref, or rotate a Claude trigger's fire token, without deleting and re-creating the connector.
 ...
 @return ApiUpdateTriggerConnectorRequest
*/
func (a *ConnectorsAPIService) UpdateTriggerConnector(ctx context.Context, id string) ApiUpdateTriggerConnectorRequest {
	return ApiUpdateTriggerConnectorRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return UpdateConnectorResponse
func (a *ConnectorsAPIService) UpdateTriggerConnectorExecute(r ApiUpdateTriggerConnectorRequest) (*UpdateConnectorResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConnectorsAPIService.UpdateTriggerConnector")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/admin/connectors/{id}/trigger"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	...
	if r.updateTriggerConnectorRequest == nil {
		return localVarReturnValue, nil, reportError("updateTriggerConnectorRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateTriggerConnectorRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
