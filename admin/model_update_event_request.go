...
func (o *UpdateEventRequest) GetProperties() []CreateEventRequestPropertiesInner {
...
// and a boolean to check if the value has been set.
func (o *UpdateEventRequest) GetPropertiesOk() ([]CreateEventRequestPropertiesInner, bool) {
	if o == nil || IsNil(o.Properties) {
		return nil, false
	}
...
func (o *UpdateEventRequest) SetProperties(v []CreateEventRequestPropertiesInner) {
	o.Properties = v
}
