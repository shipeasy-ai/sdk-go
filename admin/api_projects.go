...
func (r ApiGetProjectRequest) Execute() (*GetCurrentProjectResponse, *http.Response, error) {
	return r.ApiService.GetProjectExecute(r)
}

/*
GetProject Show a project by id
...
// Execute executes the request
//  @return GetCurrentProjectResponse
func (a *ProjectsAPIService) GetProjectExecute(r ApiGetProjectRequest) (*GetCurrentProjectResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/api/admin/projects/{id}"
...
// Project the request operates on. Optional — defaults to the project the SDK key belongs to; pass it only to scope a multi-project key (the generated client sets it once from its configuration, so per-call callers never thread it).
func (r ApiSearchResourcesRequest) XProjectId(xProjectId string) ApiSearchResourcesRequest {
	r.xProjectId = &xProjectId
	return r
}
...
func (r ApiSearchResourcesRequest) Q(q string) ApiSearchResourcesRequest {
	r.q = &q
	return r
}

func (r ApiSearchResourcesRequest) Execute() (*SearchResponse, *http.Response, error) {
	return r.ApiService.SearchResourcesExecute(r)
}

/*
SearchResources Search project resources
...
*/
func (a *ProjectsAPIService) SearchResources(ctx context.Context) ApiSearchResourcesRequest {
	return ApiSearchResourcesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ProjectsAPIService) SearchResourcesExecute(r ApiSearchResourcesRequest) (*SearchResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectsAPIService.SearchResources")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/admin/search"
...
// Project the request operates on. Optional — defaults to the project the SDK key belongs to; pass it only to scope a multi-project key (the generated client sets it once from its configuration, so per-call callers never thread it).
func (r ApiUpdateProjectRequest) XProjectId(xProjectId string) ApiUpdateProjectRequest {
	r.xProjectId = &xProjectId
	return r
}

func (r ApiUpdateProjectRequest) Execute() (*GetCurrentProjectResponse, *http.Response, error) {
	return r.ApiService.UpdateProjectExecute(r)
}

/*
UpdateProject Update the current project
...
// Execute executes the request
//  @return GetCurrentProjectResponse
func (a *ProjectsAPIService) UpdateProjectExecute(r ApiUpdateProjectRequest) (*GetCurrentProjectResponse, *http.Response, error) {
	var (
