...
*/
func (a *AlertsAPIService) CreateAlertRule(ctx context.Context) ApiCreateAlertRuleRequest {
	return ApiCreateAlertRuleRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AlertsAPIService) CreateAlertRuleExecute(r ApiCreateAlertRuleRequest) (*CreateAlertRuleResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AlertsAPIService.CreateAlertRule")
	if err != nil {
...
*/
func (a *AlertsAPIService) DeleteAlertRule(ctx context.Context, id string) ApiDeleteAlertRuleRequest {
	return ApiDeleteAlertRuleRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *AlertsAPIService) DeleteAlertRuleExecute(r ApiDeleteAlertRuleRequest) (*DeleteAlertRuleResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AlertsAPIService.DeleteAlertRule")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *AlertsAPIService) ListAlertRules(ctx context.Context) ApiListAlertRulesRequest {
	return ApiListAlertRulesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AlertsAPIService) ListAlertRulesExecute(r ApiListAlertRulesRequest) ([]ListAlertRulesResponseInner, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AlertsAPIService.ListAlertRules")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *AlertsAPIService) ListSlackChannels(ctx context.Context) ApiListSlackChannelsRequest {
	return ApiListSlackChannelsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AlertsAPIService) ListSlackChannelsExecute(r ApiListSlackChannelsRequest) (*ListSlackChannelsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AlertsAPIService.ListSlackChannels")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *AlertsAPIService) UpdateAlertRule(ctx context.Context, id string) ApiUpdateAlertRuleRequest {
	return ApiUpdateAlertRuleRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *AlertsAPIService) UpdateAlertRuleExecute(r ApiUpdateAlertRuleRequest) (*UpdateAlertRuleResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AlertsAPIService.UpdateAlertRule")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
