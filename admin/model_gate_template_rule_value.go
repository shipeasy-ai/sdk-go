...
func (dst *GateTemplateRuleValue) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(GateTemplateRuleValue)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GateTemplateRuleValue) MarshalJSON() ([]byte, error) {
...
type NullableGateTemplateRuleValue struct {
	value *GateTemplateRuleValue
	isSet bool
}

func (v NullableGateTemplateRuleValue) Get() *GateTemplateRuleValue {
	return v.value
}

func (v *NullableGateTemplateRuleValue) Set(val *GateTemplateRuleValue) {
	v.value = val
	v.isSet = true
}

func (v NullableGateTemplateRuleValue) IsSet() bool {
	return v.isSet
}

func (v *NullableGateTemplateRuleValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGateTemplateRuleValue(val *GateTemplateRuleValue) *NullableGateTemplateRuleValue {
	return &NullableGateTemplateRuleValue{value: val, isSet: true}
}

func (v NullableGateTemplateRuleValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGateTemplateRuleValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
